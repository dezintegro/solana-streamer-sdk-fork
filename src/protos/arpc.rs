// This file contains manually created protobuf definitions for ARPC protocol
...
pub struct SubscribeRequest {
    ...
    pub ping_id: ::core::option::Option<i32>,
}
...
pub struct SubscribeResponse {
    ...
    pub transaction: ::core::option::Option<SubscribeResponseTransaction>,
}

#[derive(Clone, PartialEq, Eq, ::prost::Message)]
pub struct SubscribeResponseTransaction {
    #[prost(uint64, tag = "1")]
    pub slot: u64,
    #[prost(uint32, tag = "2")]
...
pub mod arpc_service_client {
    ...
    #[derive(Debug, Clone)]
    pub struct ArpcServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }

    impl ArpcServiceClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ArpcServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            ArpcServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        /// Bidirectional streaming RPC for subscribing to transactions
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/arpc.ARPCService/Subscribe",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("arpc.ARPCService", "Subscribe"));
